                ...
                <div className="absolute right-0 bg-slate-800 flex flex-col justify-center items-center text-md 
                 w-50 h-37 mt-13 sm:hidden box-border pb-1">
                    ...
                    item.name === "Logout"?(
                        ...
                        <a key={item.name} href={item.link} className="flex items-center justify-center hover:bg-white hover:text-black 
                        w-47 h-10 rounded transition duration-100 ease-in-out">
                            {item.name}
                        </a>
                    )
                ))}
